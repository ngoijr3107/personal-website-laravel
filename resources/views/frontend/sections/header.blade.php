<section id="header" class="section_gap wow fadeIn" data-wow-duration="1.5s">
    <div class="container">
        <div class="parallax" data-relative-input="true"
            ...
            <svg width="27" height="29" data-depth="0.3" class="layer p1" xmlns="http://www.w3.org/2000/svg">
                <path
                    ...
                    fill="#C2AED9" fill-rule="evenodd"/>
            </svg>

            <svg width="26" height="26" data-depth="0.2" class="layer p2" xmlns="http://www.w3.org/2000/svg">
                <path d="M13 3.3541L2.42705 24.5h21.1459L13 3.3541z" stroke="#C2AED9" stroke-width="3" fill="none"
                      fill-rule="evenodd"/>
            </svg>
            ...
            <svg width="15" height="23" data-depth="0.6" class="layer p4" xmlns="http://www.w3.org/2000/svg">
                <rect transform="rotate(30 9.86603 10.13397)" x="7" width="3" height="25" rx="1.5" fill="#C2AED9"
                      fill-rule="evenodd"/>
            </svg>
            ...
            <svg width="49" height="17" data-depth="0.5" class="layer p6" xmlns="http://www.w3.org/2000/svg">
                <g fill="#C2AED9" fill-rule="evenodd">
                    <path
            ...
            <svg width="26" height="26" data-depth="0.4" class="layer p7" xmlns="http://www.w3.org/2000/svg">
                <path d="M13 22.6459L2.42705 1.5h21.1459L13 22.6459z" stroke="#C2AED9" stroke-width="3" fill="none"
                      fill-rule="evenodd"/>
            </svg>

            <svg width="19" height="21" data-depth="0.3" class="layer p8" xmlns="http://www.w3.org/2000/svg">
                <rect transform="rotate(-40 6.25252 10.12626)" x="7" width="3" height="25" rx="1.5" fill="#C2AED9"
                      fill-rule="evenodd"/>
            </svg>
        ...
        <div class="row justify-content-center text-center">
            <div class="col-12">
                ...
                <div class="call_to_action">
                    <a href="#works" class="btn btn-primary mr-sm-4">
                        See My Works
                    </a>
                    <a href="#about" class="btn btn-outline-primary last-child">
                        About Me
                    </a>
                </div>
            </div>
