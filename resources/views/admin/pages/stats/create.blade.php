                ...
                <form action="{{ route('stats.store') }}" method="POST">
                    ...
                    <div class="tile-body">
                        <div class="form-group">
                            ...
                            <input id="stat_title" class="form-control" type="text" placeholder="Enter stat title" name="stat_title" value="{{ old('stat_title') }}">
                        </div>

                        <div class="form-group">
                            <label class="control-label" for="stat_icon">Stat Icon  <span class="text-danger">*</span></label>
                            <input id="stat_icon" class="form-control" type="text" placeholder="Enter stat icon" name="stat_icon" value="{{ old('stat_icon') }}">
                        </div>

                        <div class="form-group">
                            <label class="control-label" for="stat_number">Stat Number  <span class="text-danger">*</span></label>
                            <input id="stat_number" class="form-control" type="number" placeholder="Enter stat number" name="stat_number" value="{{ old('stat_number') }}">
                        </div>
                    </div>
                    <div class="tile-footer d-flex justify-content-end">
                        <button class="btn btn-primary" type="submit"><i class="fa fa-fw fa-lg fa-check-circle"></i>Create Stat</button>
                    </div>
                </form>
            </div>
        </div>
