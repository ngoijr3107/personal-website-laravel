                        ...
                        <div class="form-row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="project_name" class="form-control" type="text" placeholder="Enter project title" name="project_name" value="{{ $project->project_name }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                        ...
                        <div class="form-row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="project_description" id="project_description" rows="5" class="form-control" placeholder="Enter project description">{{ $project->project_description }}</textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="code_link" class="form-control" type="text" placeholder="Enter code link" name="code_link" value="{{ $project->code_link }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="control-label" for="live_link">Live Link</label>
                                    <input id="live_link" class="form-control" type="text" placeholder="Enter live link" name="live_link" value="{{ $project->live_link }}">
                                </div>
                            </div>
                        </div>
